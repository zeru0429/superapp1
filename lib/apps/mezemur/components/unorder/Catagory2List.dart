...
class Catagory2List extends StatefulWidget {
  const Catagory2List({
    Key? key,
    required this.title,
  ...
  @override
  _Catagory2ListState createState() => _Catagory2ListState();
}
...
class _Catagory2ListState extends State<Catagory2List> {
  ...
  Future<void> _fetchDataFromDatabase() async {
    ...
    try {
      final data = await dbHelper.listCatagorized2Data(widget.title);
